...
const RealtimeSettlementShow: React.FC = () => {
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/payment-systems/RealTimeSettlementSystem/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="RealTimeSettlementSystem" />
      <DataTable
        ...
        // onEditLocation={item =>
        //   `/payment-systems/RealTimeSettlementSystem/edit/${item.id}`
        // }
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
...
export default RealtimeSettlementShow;
