...
const InstantPaymentSystemControlFilelerShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['InstantPaymentSystemControlFileler'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/payment-systems/InstantPaymentSystemControlFileler/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="InstantPaymentSystemControlFileler" />
      <DataTable
        columns={columns}
        data={filteredData}
        ...
        // onEditLocation={item =>
        //   `/payment-systems/InstantPaymentSystemControlFileler/edit/${item.id}`
        // }
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
...
export default InstantPaymentSystemControlFilelerShow;
