...
const IndexIncreasingShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['market/import-index-increasing'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/index-increasing/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="market/import-index-increasing" />
      <DataTable
        ...
        onEditLocation={item => `/index-increasing/edit/${item.id}`}
        onEdit={() => {}}
        onDelete={() => {}}
        refetch={refetch}
      />
...
export default IndexIncreasingShow;
