...
const MarketInformationShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['market/import-market-information'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/market-information/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="market/import-market-information" />
      <DataTable
        ...
        onEditLocation={item => `/market-information/edit/${item.id}`}
        onEdit={() => {}}
        onDelete={() => {}}
        refetch={refetch}
      />
...
export default MarketInformationShow;
