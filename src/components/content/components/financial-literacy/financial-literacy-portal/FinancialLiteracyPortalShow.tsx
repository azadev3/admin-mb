...
const FinancialLiteracyPortalShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['FinancialLiteracyPortal'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/financial-literacy/FinancialLiteracyPortal/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="FinancialLiteracyPortal" />
      <DataTable
        ...
        // onEditLocation={item => `/financial-literacy/FinancialLiteracyPortal/edit/${item.id}`}
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
      />
...
export default FinancialLiteracyPortalShow;
