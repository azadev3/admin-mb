...
const FinancialLiteracyPortalCaptionShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['FinancialLiteracyPortalCaption'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/financial-literacy/FinancialLiteracyPortalCaption/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="FinancialLiteracyPortalCaption" />
      <DataTable
        ...
        // onEditLocation={item => `/financial-literacy/FinancialLiteracyPortalCaption/edit/${item.id}`}
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
      />
...
export default FinancialLiteracyPortalCaptionShow;
