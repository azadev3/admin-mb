...
const FinancialSearchSystemShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['FinancialSearchSystem'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/financial-literacy/FinancialSearchSystem/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="FinancialSearchSystem" />
      <DataTable
        ...
        // onEditLocation={item => `/financial-literacy/FinancialSearchSystem/edit/${item.id}`}
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
      />
...
export default FinancialSearchSystemShow;
