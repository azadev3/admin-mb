...
const FinancialSearchSystemCaptionShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['FinancialSearchSystemCaption'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/financial-literacy/FinancialSearchSystemCaption/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="FinancialSearchSystemCaption" />
      <DataTable
        ...
        // onEditLocation={item => `/financial-literacy/FinancialSearchSystemCaption/edit/${item.id}`}
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
      />
...
export default FinancialSearchSystemCaptionShow;
