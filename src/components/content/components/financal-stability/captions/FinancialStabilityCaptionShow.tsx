...
const FinancialStabilityCaptionShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['FinancialStabilityCaption'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/financial-stability/FinancialStabilityCaption/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="FinancialStabilityCaption" />
      <DataTable
        ...
        // onEditLocation={item => `/financial-stability/FinancialStabilityCaption/edit/${item.id}`}
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
      />
...
export default FinancialStabilityCaptionShow;
