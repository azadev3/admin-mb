...
const MacroprudentialPolicyFrameworkShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['MacroprudentialPolicyFramework'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/financial-stability/MacroprudentialPolicyFramework/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="MacroprudentialPolicyFramework" />
      <DataTable
        ...
        onEditLocation={item =>
          `/financial-stability/MacroprudentialPolicyFramework/edit/${item.id}`
        }
        onEdit={() => {}}
        onDelete={() => {}}
        refetch={refetch}
...
export default MacroprudentialPolicyFrameworkShow;
