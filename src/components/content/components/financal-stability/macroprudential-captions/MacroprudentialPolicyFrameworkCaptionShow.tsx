...
const MacroprudentialPolicyFrameworkCaptionShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['MacroprudentialPolicyFrameworkCaption'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/financial-stability/MacroprudentialPolicyFrameworkCaption/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="MacroprudentialPolicyFrameworkCaption" />
      <DataTable
        ...
        // onEditLocation={item => `/financial-stability/MacroprudentialPolicyFrameworkCaption/edit/${item.id}`}
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
      />
...
export default MacroprudentialPolicyFrameworkCaptionShow;
