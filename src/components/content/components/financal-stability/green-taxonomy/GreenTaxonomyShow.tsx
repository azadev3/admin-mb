...
const GreenTaxonomyShow: React.FC = () => {
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/financial-stability/GreenTaxonomy/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="GreenTaxonomy" />
      <DataTable
        ...
        // onEditLocation={item => `/financial-stability/GreenTaxonomy/edit/${item.id}`}
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
      />
...
export default GreenTaxonomyShow;
