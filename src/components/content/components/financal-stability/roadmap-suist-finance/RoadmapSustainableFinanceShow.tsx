...
const RoadmapSustainableFinanceShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['RoadmapSustainableFinance'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/financial-stability/RoadmapSustainableFinance/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="RoadmapSustainableFinance" />
      <DataTable
        ...
        // onEditLocation={item => `/financial-stability/RoadmapSustainableFinance/edit/${item.id}`}
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
      />
...
export default RoadmapSustainableFinanceShow;
