...
const FinancingActivityCaptionShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['FinancingActivityCaption'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/financial-stability/FinancingActivityCaption/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="FinancingActivityCaption" />
      <DataTable
        ...
        // onEditLocation={item => `/financial-stability/FinancingActivityCaption/edit/${item.id}`}
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
      />
...
export default FinancingActivityCaptionShow;
