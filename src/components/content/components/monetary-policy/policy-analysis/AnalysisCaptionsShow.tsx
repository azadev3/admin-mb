...
const fetchData = async (): Promise<DataInterface[]> => {
  const res = await apiRequest({ endpoint: 'PolicyAnalysis', method: 'get' });
...
const AnalysisCaptionsShow: React.FC = () => {
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/pul-siyaseti/analysis-descriptions/create"
        onRefresh={refetch}
...
export default AnalysisCaptionsShow;
