...
const fetchData = async (): Promise<DataInterface[]> => {
  const res = await apiRequest({ endpoint: 'operatorbankcaption', method: 'get' });
  if (!res) return [];
...
const OperatorCaptionsShow: React.FC = () => {
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/market-participants/banks/operator/captions/create"
        onRefresh={refetch}
...
export default OperatorCaptionsShow;
