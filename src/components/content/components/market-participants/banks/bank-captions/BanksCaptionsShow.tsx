...
const fetchData = async (): Promise<DataInterface[]> => {
  const res = await apiRequest({ endpoint: 'bankcaption', method: 'get' });
  if (!res) return [];
...
const BanksCaptionsShow: React.FC = () => {
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/market-participants/banks/captions/create"
        onRefresh={refetch}
...
export default BanksCaptionsShow;
