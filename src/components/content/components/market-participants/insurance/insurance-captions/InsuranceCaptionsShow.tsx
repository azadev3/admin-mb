...
const fetchData = async (): Promise<DataInterface[]> => {
  const res = await apiRequest({ endpoint: 'insurercaption', method: 'get' });
  if (!res) return [];
...
const InsuranceCaptionsShow: React.FC = () => {
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/market-participants/insurance/captions/create"
        onRefresh={refetch}
...
export default InsuranceCaptionsShow;
