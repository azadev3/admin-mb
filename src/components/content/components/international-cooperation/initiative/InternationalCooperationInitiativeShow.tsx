...
const InternationalCooperationInitiativeShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['InternationalCooperationInitiative'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/international-cooperation/InternationalCooperationInitiative/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="InternationalCooperationInitiative" />
      <DataTable
        ...
        onEditLocation={item =>
          `/international-cooperation/InternationalCooperationInitiative/edit/${item.id}`
        }
        onEdit={() => {}}
        onDelete={() => {}}
        refetch={refetch}
...
export default InternationalCooperationInitiativeShow;
