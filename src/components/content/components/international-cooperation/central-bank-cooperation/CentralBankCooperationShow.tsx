...
const CentralBankCooperationShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['CentralBankCooperation'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/international-cooperation/CentralBankCooperation/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="CentralBankCooperation" />
      <DataTable
        ...
        onEditLocation={item =>
          `/international-cooperation/CentralBankCooperation/edit/${item.id}`
        }
        onEdit={() => {}}
        onDelete={() => {}}
        refetch={refetch}
...
export default CentralBankCooperationShow;
