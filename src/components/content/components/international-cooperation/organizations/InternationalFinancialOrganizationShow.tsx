...
const InternationalFinancialOrganizationShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['InternationalFinancialOrganization'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/international-cooperation/InternationalFinancialOrganization/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="InternationalFinancialOrganization" />
      <DataTable
        ...
        // onEditLocation={item => `/international-cooperation/InternationalFinancialOrganization/edit/${item.id}`}
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
      />
...
export default InternationalFinancialOrganizationShow;
