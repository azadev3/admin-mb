...
const CaptionsShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['CentralBankCooperationCaption'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/international-cooperation/CentralBankCooperationCaption/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="CentralBankCooperationCaption" />
      <DataTable
        ...
        // onEditLocation={item => `/international-cooperation/CentralBankCooperationCaption/edit/${item.id}`}
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
      />
