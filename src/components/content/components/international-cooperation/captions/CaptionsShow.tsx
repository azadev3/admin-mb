...
const CaptionsShow: React.FC = () => {
  ...
  const {
    ...
    queryKey: ['InternationalCooperationCaption'],
    queryFn: fetchData,
    retry: 2,
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/international-cooperation/InternationalCooperationCaption/create"
        onRefresh={refetch}
        dataLoading={isLoading || isFetching}
      />
      <DeleteModal endpoint="InternationalCooperationCaption" />
      <DataTable
        ...
        // onEditLocation={item => `/international-cooperation/InternationalCooperationCaption/edit/${item.id}`}
        // onEdit={() => {}}
        // onDelete={() => {}}
        refetch={refetch}
      />
