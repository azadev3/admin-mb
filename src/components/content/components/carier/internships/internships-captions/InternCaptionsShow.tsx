...
const fetchData = async (): Promise<DataInterface[]> => {
  const res = await apiRequest({ endpoint: 'internshipcaption', method: 'get' });
  if (!res) return [];
...
const InternCaptionsShow: React.FC = () => {
  ...
  return (
    <VStack w="100%" align="stretch" spacing={4} p={4} bg="gray.50" borderRadius="md">
      <UserManagement
        createButtonLocation="/carier/intern/captions/create"
        onRefresh={refetch}
...
export default InternCaptionsShow;
